...
export default function Users() {
    ...
    const handleindChange = (e) =>{
      setUserData({...userData2,[e.target.name]:e.target.value})
    }
    ...
    window.onclick = function(event) {
      ...
      useEffect(() => {
        async function fetchCountries() {
            try {
              const response = await fetch(`http://127.0.0.1:5000/api/users/${redata.REGION.id}`);
              const data = await response.json();
              setUsers(data);
              console.log(users)
            } catch (error) {
            ...
            <div key={user.id} style={{ marginBottom: '20px' }}>
              ...
              <div className={style.modalContent}>
                ...
                <form onSubmit={(e) =>handleindSubmit(e,user.id)}>
                  <label htmlFor="regionid" style={{marginLeft:"120px"}}>Region Id </label>
                  <select className={style.selctuser} name="regionId" id="" defaultValue={user.regionId} value={userData2.regionId} onChange={handleAddChange} style={{marginLeft:"40px",marginBottom:"5px"}}>
                  ...
                  <input className={style.selctuser} type="text" style={{marginLeft:"70px",marginBottom:"5px"}} name='name' defaultValue={user.name} value={userData2.name} onChange={handleAddChange} /><br />
                  <label htmlFor="Father Name" style={{marginLeft:"120px"}}>Father Name</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"25px",marginBottom:"5px"}} name='fatherName' defaultValue={user.fatherName} value={userData2.fatherName} onChange={handleAddChange} /><br />
                  <label htmlFor="age" style={{marginLeft:"120px"}}>age</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"85px",marginBottom:"5px"}} name='age' defaultValue={user.age} value={userData2.age} onChange={handleAddChange}/><br />
                  <label htmlFor="gender" style={{marginLeft:"120px"}}>gender </label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"60px",marginBottom:"5px"}} name="gender" defaultValue={user.gender} value={userData2.gender} onChange={handleAddChange}/><br />
                  <label htmlFor="caste" style={{marginLeft:"120px"}}>caste </label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"70px",marginBottom:"5px"}} name='caste' defaultValue={user.caste} value={userData2.caste}  onChange={handleAddChange}/><br />
                  <label htmlFor="religion" style={{marginLeft:"120px"}}>religion </label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"50px",marginBottom:"5px"}} name='religion' defaultValue={user.religion} value={userData2.religion} onChange={handleAddChange} /><br />
                  <label htmlFor="education" style={{marginLeft:"120px"}}>education </label>
                  <select className={style.selctuser} name="education" style={{marginLeft:"40px",marginBottom:"5px"}} id="" defaultValue={user.education} value={userData2.education} onChange={handleAddChange}>
                  ...
                  <select className={style.selctuser} name="employment" id="" style={{marginLeft:"20px",marginBottom:"5px"}} defaultValue={user.employment} value={userData2.employment} onChange={handleAddChange}>
                  ...
                  <input className={style.selctuser} type="text" style={{marginLeft:"60px",marginBottom:"5px"}} name='voterId' defaultValue={user.voterId} value={userData2.voterId} onChange={handleAddChange} /><br />
                  <label htmlFor="boothNo" style={{marginLeft:"120px"}}>booth no</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"50px",marginBottom:"5px"}} name='boothNo' defaultValue={user.boothNo} value={userData.boothNo} onChange={handleAddChange} /><br />
                  <label htmlFor="pre_voting_date" style={{marginLeft:"120px"}}>pre_voting_date</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"5px",marginBottom:"5px"}} name='preVotingDate' defaultValue={user.preVotingDate} value={userData2.preVotingDate} onChange={handleAddChange} /><br />
                  <label htmlFor="prev_vote_to" style={{marginLeft:"120px"}}>prev_vote_to</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"25px",marginBottom:"5px"}} name='preVoteTo' value={userData2.preVoteTo} defaultValue={user.preVoteTo} onChange={handleAddChange} /><br />
                  <label htmlFor="membership" style={{marginLeft:"120px"}}>membership</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"30px",marginBottom:"5px"}} name='membership' value={userData2.membership} defaultValue={user.membership} onChange={handleAddChange} /><br />
                  <label htmlFor="affiliation"style={{marginLeft:"120px"}}>affiliation</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"45px",marginBottom:"5px"}} name='affiliation' value={userData2.affiliation} defaultValue={user.affiliation} onChange={handleAddChange} /><br />
                  <label htmlFor="influence_factor" style={{marginLeft:"120px"}}>influence_factor</label>
                  <input className={style.selctuser} type="text" style={{marginLeft:"5px",marginBottom:"5px"}} name='influenceFactor' value={userData2.influenceFactor} defaultValue={user.influenceFactor} onChange={handleAddChange} /><br />
