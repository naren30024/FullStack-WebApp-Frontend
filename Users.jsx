            ...
            <div key={user.id} style={{ marginBottom: '20px' }}>
              ...
              <div className={style.modalContent}>
                ...
                <form onSubmit={(e) =>handleindSubmit(e,user.id)}>
                  ...
                  <select className={style.selctuser} name="regionId" id="" value={userData.regionId} onChange={handleindChange} style={{marginLeft:"40px",marginBottom:"5px"}}>
                  ...
                  <input className={style.selctuser} type="text" style={{marginLeft:"70px",marginBottom:"5px"}} name='name'  value={userData2.name} onChange={handleindChange} /><br />
                  ...
                  <input className={style.selctuser} type="text" style={{marginLeft:"50px",marginBottom:"5px"}} name='boothNo' defaultValue={user.boothNo} value={userData.boothNo} onChange={handleindChange} /><br />
